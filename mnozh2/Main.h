...
public:
    ...
    void __fastcall Ob(TStringList * m_A, TStringList * m_B, TStringList * res);
    void __fastcall Pe(TStringList * m_A, TStringList * m_B, TStringList * res);
    void __fastcall Dupes(TStringList * lst);
    void __fastcall Obr(TStringList * m_A, TStringList * res);
};
//---------------------------------------------------------------------------
